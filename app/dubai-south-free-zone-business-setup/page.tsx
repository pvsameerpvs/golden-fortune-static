...
export default function DubaiSouthSetup() {
  return (
    <ServicePage
      ...
      advantages={[
        "Leading global trade, business, and aviation hub",
        "Most suitable corporate structure for aviation and logistics",
        "Simple business licensing process",
        "Multi-currency corporate bank accounts",
        "Effortless compliance with UAE laws",
        "Conducive environment for business success",
        "Strategic location for global shipment"
      ]}
    />
  );
}
